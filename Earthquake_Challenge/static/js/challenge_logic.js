...
// 1. Add a 2nd layer group for the tectonic plate data, 3rd layer group for the major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicData = new L.LayerGroup();
let majorEarthquake = new L.LayerGroup();


// 2. Add a reference to all earthquakes,tectonic plates & major earquakes group to the overlays object.
let overlays = {
